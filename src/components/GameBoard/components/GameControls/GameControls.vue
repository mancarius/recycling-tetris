...
const canMove = computed<boolean>(() => store.getters[Getters.GAME_IS_RUNNING]);
...
<template>
    <div class="game-actions">
        ...
        <div class="space">
            ...
            <button tabindex="-1" class="nes-btn is-warning" @mousedown.passive="actionStart(ControlKeys.SPACE)" @mouseup.passive="actionStop" :disabled="!canMove">
        ...
        <div class="menu">
            ...
            <button tabindex="-1" class="nes-btn" @mousedown.passive="pause" @mouseup.passive="actionStop" :disabled="!canMove">
        ...
        <div class="directions">
            ...
            <div class="wrapper">
                ...
                <button tabindex="-1" class="nes-btn is-error control-up" @mousedown.passive="actionStart(ControlKeys.UP)" @mouseup.passive="actionStop" :disabled="!canMove">
    
              <i class="nes-icon caret-up is-small"></i>
    
            </button>
    
                <button tabindex="-1" class="nes-btn is-primary control-left" @mousedown.passive="actionStart(ControlKeys.LEFT)" @mouseup.passive="actionStop" :disabled="!canMove">
    
              <i class="nes-icon caret-left is-small"></i>
    
            </button>
    
                <button tabindex="-1" class="nes-btn is-primary control-down" @mousedown.passive="actionStart(ControlKeys.DOWN)" @mouseup.passive="actionStop" :disabled="!canMove">
    
              <i class="nes-icon caret-down is-small"></i>
    
            </button>
    
                <button tabindex="-1" class="nes-btn is-primary control-right" @mousedown.passive="actionStart(ControlKeys.RIGHT)" @mouseup.passive="actionStop" :disabled="!canMove">
